...
-- 8. Zeigen Sie für alle Mitarbeiter, deren Managerkennung kleiner 130 ist, 
-- Folgendes an:
...
-- 9. Erweitern Sie Aufgabe 8, so dass zusätzlich angezeigt wird:
...
-- 10. Erweitern Sie Aufgabe 9 um eine Anzeige, die deutlich macht, 
...
SELECT manager_id, job_id, 
       ...
       CASE grouping(manager_id) WHEN 1 THEN 'Aggregiert'
                                 ELSE ' '   -- leere Zeichkette wird eventuell vom Tool als "null" ausgegeben
                                 END  AS "Sum_je_Man",
...
-- oder, ebenfalls via Case, aber in den Gruppierungsspalten vernünftig angezeigt
...
-- 11. Erweitern Sie die Abfrage aus Aufgabe 10, so dass zusätzlich angezeigt 
...
-- 12. Modifizieren Sie die Abfrage aus Aufgabe 9, so dass nur folgende 
...
-- 13. Zeigen Sie je Kalenderjahr an, wieviele Angestellte jeweils eingestellt wurden.  
...
-- 14. Erstellen Sie eine Abfrage, um folgende Angaben für alle Abteilungen anzuzeigen,
...
-- 15  Erstellen Sie eine Abfrage, um folgende Gruppierungen anzuzeigen:

...
-- 4.	Zeigen Sie für alle Mitarbeiter den Nachnamen und die Anzahl der Monate zwischen dem aktuellen Datum 
-- und dem Einstellungsdatum, sortiert nach der Anzahl Monate. Runden Sie die Anzahl auf eine ganze Zahl.

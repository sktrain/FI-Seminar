...
/* Aufgabe 4 Erstellen Sie eine Abfrage, die bei der Anzeige der Strassen (Spalte
STREET_ADDRESS) aus der Tabelle LOCATIONS das Kürzel 'St' durch 'Street' ersetzt.
Achten Sie darauf, dass keine Zeilen betroffen sind, die 'Street' bereits enthalten,
wobei Sie sich darauf stützen können, dass das Kürzel 'St' stets am Ende steht. */
...
/* Aufgabe 5  Fügen Sie bei der Anzeige des Ländernamens aus der COUNTRIES-Tabelle
nach jedem Zeichen des Namens ein Leerzeichen ein (sportliche Aufgabe)
*/
SELECT REGEXP_REPLACE(country_name, '(.)', '\1 ') FROM countries;


/* Aufgabe 6  Suchen Sie bei den Vornamen der Mitarbeiter nach Palindromen der Länge 4
(Palindrome sind Zeichenketten, die vorwärts und rückwärts gelesen gleich sind,
z.B. 'otto'. (sportliche Aufgabe)  */

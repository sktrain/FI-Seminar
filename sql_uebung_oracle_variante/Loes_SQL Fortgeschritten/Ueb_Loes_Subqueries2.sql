...
/* Aufgabe 1 - Listen Sie Nachname, Abteilungsnummer und Gehalt eines jeden Mitarbeiter auf,
dessen Abteilung und Gehaltswert mit dem Gehalt und zugleich der Abteilungsnummer eines
Mitarbeiters übereinstimmt, der eine Provision (commission_pct) erhält */
...
/* Aufgabe 2 - Listen Sie Nachname, Einstellungsdatum und Gehalt eines jeden Mitarbeiter an,
der das  gleiche Gehalt und die gleiche Provision wie der Mitarbeiter 'Kochhar' erhält.
Kochhar soll nicht im Ergebnis enthalten sein */
